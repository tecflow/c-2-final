...
function final_setup() {
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'final' ),
			'company-menu' => esc_html__( 'Company', 'final' ),
            'contact-menu' => esc_html__( 'Contact', 'final' ),
            'more-menu'    => esc_html__( 'More', 'final' ),
		)
	);
...
function final_scripts() {
	wp_enqueue_style( 'final-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'final-style', 'rtl', 'replace' );

	wp_enqueue_script( 'final-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
